...
export default function STDUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = sTDRecord
      ? { ...initialValues, ...sTDRecord }
      : initialValues;
    setState(cleanValues.state);
    setFacepage(cleanValues.facepage);
    setMasterapplication(cleanValues.masterapplication);
    setTableofcontents(cleanValues.tableofcontents);
    setDefinitions(cleanValues.definitions);
  ...
  return (
    <Grid
      ...
      {...getOverrideProps(overrides, "STDUpdateForm")}
      {...rest}
    >
      <TextField
        label="State"
